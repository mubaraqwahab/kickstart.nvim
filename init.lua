...
- Learn the basics of lua at https://learnxinyminutes.com/docs/lua/
- Run `:help lua-guide` to learn how Neovim integrates with Lua
- Press <space>sh to [s]earch the [h]elp documentation
- Run `:checkhealth` when you experience any erros while installing things
...
-- Hide line numbers in embedded terminal
